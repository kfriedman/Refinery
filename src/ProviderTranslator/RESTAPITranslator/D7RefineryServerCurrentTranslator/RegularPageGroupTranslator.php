 ...
 */
class RegularPageGroupTranslator extends D7RefineryServerTranslator implements RESTAPITranslator\ReadInterface
{
    /**
     ...
     *
     * @return NDO\RegularPageGroup
     */
    public function translate(ProviderRawData $providerRawData)
    {
        $rawDataArray = $providerRawData->getRawDataArray();

        $ndo = new NDO\RegularPageGroup();

        foreach ($rawDataArray as $rawData) {
            $providerTranslator = new RegularPageTranslator();
