 ...
 */
class ExhibitionGroupTranslator extends D7RefineryServerTranslator implements RESTAPITranslator\ReadInterface
{
    /**
    ...
    public function translate(ProviderRawData $providerRawData)
    {
        ...
        $ndo = new NDO\ExhibitionGroup();

        foreach ($rawDataArray as $rawData) {
            $providerTranslator = new ExhibitionTranslator();
