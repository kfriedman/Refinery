 ...
 */
class EventProgramGroupTranslator extends D7RefineryServerTranslator implements RESTAPITranslator\ReadInterface
{
    /**
     ...
     *
     * @return NDO\EventProgramGroup
     */
    public function translate(ProviderRawData $providerRawData)
    {
        $rawDataArray = $providerRawData->getRawDataArray();

        $ndo = new NDO\EventProgramGroup();

        foreach ($rawDataArray as $rawData) {
            $providerTranslator = new EventProgramTranslator();
