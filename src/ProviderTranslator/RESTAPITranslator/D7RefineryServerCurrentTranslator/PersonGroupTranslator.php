 ...
 */
class PersonGroupTranslator extends D7RefineryServerTranslator implements RESTAPITranslator\ReadInterface
{
    /**
     ...
     *
     * @return NDO\PersonGroup
     */
    public function translate(ProviderRawData $providerRawData)
    {
        return $this->getNDOGroupFromRawData($providerRawData, new NDO\PersonGroup(), new PersonTranslator());
    }
}
