 ...
 */
class LocationHoursGroupTranslator extends D7RefineryServerTranslator implements RESTAPITranslator\ReadInterface
{
    /**
    ...
    {
        return $provider->clientGet('other/location_hours', null, $ndoFilter, $allowEmptyResults);
    }
    ...
    public function translate(ProviderRawData $providerRawData)
    {
        ...
        $ndo = new NDO\LocationHoursGroup();

        foreach ($rawDataArray as $rawData) {
            $providerTranslator = new LocationHoursTranslator();
