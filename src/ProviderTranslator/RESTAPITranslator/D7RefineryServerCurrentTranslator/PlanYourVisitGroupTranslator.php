...
/**
 * Translator for BasicPage NDO
 *
 * @package NYPL\Refinery\ProviderTranslator
 */
class PlanYourVisitGroupTranslator extends D7RefineryServerTranslator implements RESTAPITranslator\ReadInterface
{
    /**
    ...
    {
        return $provider->clientGet('node/plan_your_visit', null, $ndoFilter, $allowEmptyResults);
    }
    ...
    public function translate(ProviderRawData $providerRawData)
    {
        ...
        $ndo = new NDO\PlanYourVisitGroup();

        foreach ($rawDataArray as $rawData) {
            $providerTranslator = new PlanYourVisitTranslator();
