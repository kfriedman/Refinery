 ...
 */
class ContainerSlotGroupTranslator extends D7RefineryServerTranslator implements RESTAPITranslator\ReadInterface
{
    /**
     ...
     *
     * @return NDO\SiteDatum\ContainerSlotGroup
     */
    public function translate(ProviderRawData $providerRawData)
    {
        return $this->getNDOGroupFromRawData($providerRawData, new NDO\SiteDatum\ContainerSlotGroup(), new ContainerSlotTranslator());
    }
