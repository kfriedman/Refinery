 ...
 */
class EnhancedImageGroupTranslator extends D7RefineryServerTranslator implements RESTAPITranslator\ReadInterface
{
    /**
    ...
    public function read(RESTAPI $provider, NDOFilter $ndoFilter, $allowEmptyResults = false)
    {
        if ($ndoFilter->getFilterID()) {
            ...
            return $provider->clientGet('node_file', null, $urlFilter, $allowEmptyResults);
        } else {
            return null;
        }
    }
    ...
    {
        return $this->getNDOGroupFromRawData($providerRawData, new NDO\EnhancedImageGroup(), new EnhancedImageTranslator());
    }
}
