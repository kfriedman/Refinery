 ...
 */
class MediaTypeTranslator extends D7RefineryServerTranslator implements RESTAPITranslator\ReadInterface
{
    /**
    ...
    {
        return $provider->clientGet('taxonomy/term/media_types/' . $ndoFilter->getFilterID(), null, $ndoFilter, $allowEmptyResults);
    }
    ...
    {
        $ndo = new NDO\Term\MediaType($this->getValueFromRawData($providerRawData, 'uuid'));
